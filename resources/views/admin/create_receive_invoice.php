...
<style>
    ...
    /* TomSelect Alignment inside Context Card for Supplier Selection */
    ...
    <div class="pos-container">
        ...
        <div class="pos-header-bar">
            ...
            <div class="pos-shortcuts-legend">
                ...
                <div class="shortcut-pill">
                    <span class="shortcut-key">F9</span> Save & Print
                </div>
                <div class="shortcut-pill">
        ...
        <form method="POST" action="" id="receiveInvoiceForm">
            ...
            <div class="pos-context-card" style="margin-bottom: 20px;">
                <div class="pos-context-header">
                    <div class="pos-context-title">
                        <i class="fas fa-truck-loading" style="color: var(--primary-color);"></i> Shipment Intake & Supplier Details
                    </div>
                    ...
                    <div class="recv-context-col">
                        ...
                        <div class="pos-field-group">
                            ...
                            <div class="pos-input-wrapper">
                                ...
                                <input type="text" name="reference_number" id="reference_number" class="pos-input-field" required placeholder="Enter supplier's bill or receipt #">
                            </div>
                        </div>
                    </div>

                    <!-- Right Column: System Invoice Number & Received Date -->
                    <div class="recv-context-col">
                        <div class="pos-field-group">
                            ...
                            <div class="pos-input-wrapper">
                                ...
                                <input type="text" id="invoice_number" class="pos-input-field" value="<?php echo htmlspecialchars($nextInvoiceNumber); ?>" readonly tabIndex="-1" style="background-color: var(--surface-hover); font-weight: 700; letter-spacing: 0.5px;">
                            </div>
                        </div>
            ...
            <div class="pos-workstation-grid">
                ...
                <div class="pos-items-card">
                    <div class="pos-items-header">
                        <div class="pos-items-title">
                            <i class="fas fa-boxes" style="color: var(--primary-color);"></i> Delivered Medicine Items 
                    ...
                    <div class="recv-table-wrapper">
                        ...
                        <div class="pos-empty-state" id="posEmptyState" style="display: none;">
                            <div class="pos-empty-icon"><i class="fas fa-pills"></i></div>
                            <p style="margin:0; font-weight: 600;">No delivered items added yet</p>
                ...
                $saveBtnText = 'Save Receive Invoice';
...
<script>
    ...
    function updateRow(rowId) {
        ...
        if (selectedOption && selectedOption.value) {
            ...
            // Default received cost to current cost if empty or NaN
    ...
    function confirmClearForm() {
        if (confirm('Are you sure you want to clear all items from this receive invoice?')) {
    ...
    document.addEventListener('keydown', function(e) {
        ...
        // F9 -> Submit Form (Save Receive Invoice)
        else if (e.key === 'F9') {
            e.preventDefault();
